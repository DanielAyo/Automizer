/*
  ...
  Header modified from http://isophonics.net/sites/isophonics.net/files/nnls-chroma-0.2.1.tgz [Accessed 26th August 2013]
*/
...
//These windows weight the influence of chroma values at different frequencies. 
